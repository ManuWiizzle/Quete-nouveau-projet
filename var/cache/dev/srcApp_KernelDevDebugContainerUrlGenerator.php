...
class srcApp_KernelDevDebugContainerUrlGenerator extends Symfony\Component\Routing\Generator\UrlGenerator
{
    ...
    public function __construct(RequestContext $context, LoggerInterface $logger = null, string $defaultLocale = null)
    {
        ...
        'blog_show' => [['slug'], ['slug' => null, '_controller' => 'App\\Controller\\BlogController::show'], ['slug' => '[a-z0-9-]+'], [['variable', '/', '[a-z0-9-]+', 'slug', true], ['text', '/blog/show']], [], []],
        ...
        'category_show' => [['id'], ['_controller' => 'App\\Controller\\CategoryController::show'], ['id' => '\\d+'], [['variable', '/', '\\d+', 'id', true], ['text', '/category']], [], []],
        ...
        'category_articles' => [['name'], ['_controller' => 'App\\Controller\\CategoryController::showArticles'], [], [['variable', '/', '[^/]++', 'name', true], ['text', '/category']], [], []],
