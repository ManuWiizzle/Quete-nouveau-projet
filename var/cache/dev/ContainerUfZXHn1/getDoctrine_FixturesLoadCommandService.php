...
$a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\ArticlesFixtures(($this->privates['App\\Service\\Slugify'] ?? ($this->privates['App\\Service\\Slugify'] = new \App\Service\Slugify()))), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\CategoryFixtures(), 'groups' => []]]);
