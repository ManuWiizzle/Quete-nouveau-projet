...
class __TwigTemplate_7a57365a3b2f0a48b40b58963ce15c709b1af851a01a8d06ae8045faa20d38ad extends \Twig\Template
{
    private $source;
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo "\" onsubmit=\"return confirm('Etes-vous sur de vouloir supprimer cet article?');\">
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('category_delete', {'id': category.id}) }}\" onsubmit=\"return confirm('Etes-vous sur de vouloir supprimer cet article?');\">
    <input type=\"hidden\" name=\"_method\" value=\"DELETE\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ category.id) }}\">
    <button class=\"btn btn-danger\">Supprimer</button>
</form>", "category/_delete_form.html.twig", "/home/manu/Quete-nouveau-projet/templates/category/_delete_form.html.twig");
    }
}
