...
// Returns the private 'App\Repository\AticleRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/AticleRepository.php';

return $this->privates['App\\Repository\\AticleRepository'] = new \App\Repository\AticleRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
